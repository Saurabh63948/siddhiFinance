...
const AdminDashboard = ({ people, setPeople }) => {
  ...
  const handleSaveEdit = async () => {
    ...
    try {
      const response = await axios.put(
        `https://mfinancebackend.onrender.com/api/customers/${editingId}`,
        editData,
        {
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await axios.delete(`https://mfinancebackend.onrender.com/api/customers/${id}`, {
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  const handleAddPayment = async (e) => {
    ...
    try {
      const response = await axios.post(
        `https://mfinancebackend.onrender.com/api/customers/${selectedUser._id}/add-payment`,
        {
  ...
  const handleAddFine = async (e) => {
    ...
    try {
      const response = await axios.post(
        `https://mfinancebackend.onrender.com/api/customers/${selectedUser._id}/add-fine`,
        {
